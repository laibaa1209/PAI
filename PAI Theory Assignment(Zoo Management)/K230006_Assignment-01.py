...
class Mammal(Animal):
    ...
    def display_info(self):
        # Override display_info to include specific attributes for mammals
...
class Bird(Animal):
    ...
    def display_info(self):
        # Override display_info to include specific attributes for birds
        super().display_info()  # Call the display_info method from the base class
...
class Reptile(Animal):
    ...
    def display_info(self):
        # Override display_info to include specific attributes for reptiles
        super().display_info()  # Call the display_info method from the base class
...
def main():
    ...
    print("Reptile 1:\n")
    reptile1.display_info()
    print("\nReptile 2:\n")
    reptile2.display_info()

    # Changing availability of some animals
